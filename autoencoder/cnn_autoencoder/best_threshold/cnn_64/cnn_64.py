...
if __name__ == "__main__":
    try: 
        ...
        output_dir = Path("results_cnn_64")
        ...
        with open(output_dir / "autoencoder_result_cnn_64.json", "w", encoding="utf-8") as f:
            json.dump(results_json, f, indent=4)
        print(f"\Τα αποτελέσματα αποθηκεύτηκαν στο: results/autoencoder_results_cnn_64.json")
